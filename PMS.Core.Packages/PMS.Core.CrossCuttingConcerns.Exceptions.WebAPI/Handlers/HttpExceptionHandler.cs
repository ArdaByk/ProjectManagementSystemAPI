...
using PMS.Core.CrossCuttingConcerns.Exceptions.Extensions;
using PMS.Core.CrossCuttingConcerns.Exceptions.HttpProblemDetails;
using PMS.Core.CrossCuttingConcerns.Exceptions.Types;
using PMS.Core.CrossCuttingConcerns.Exceptions.WebAPI.HttpProblemDetails;
using System;
...
public class HttpExceptionHandler : ExceptionHandler
{
    ...
    public HttpResponse Response { get => _response??throw new ArgumentNullException(nameof(_response)); set => _response = value; }
